...
def get_ff(rcut=12.0*angstrom, use_lammps=True, smooth_ei=False, supercell=(1,1,1), tailcorr=False):
    ...
    ff = ForceField.generate(system, 'pars_short.txt', rcut=rcut, alpha_scale=3.2, gcut_scale=1.5, smooth_ei=smooth_ei)
    ...
    if use_lammps:
        ...
        ff = ForceField(system, [part_valence, pair_gauss], nlist)
...
if __name__=='__main__':
    ...
    servername = 'UiO66_160_H2O_Trotter_32_300K_short'
